...
import { getTableColumns, formatDataForChart, getChartConfig, generateSampleData, validateInputs, recoverData } from './adminBioUtil';
...
const GeothermalAdmin = () => {
 ...
 const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const payload = {
        Year: selectedYear,
        'Biomass (GWh)': parseFloat(generationValue),
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Data Table */}
      <DataTable
        title={`Biomass Power Generation Records (${yearRange.startYear} - ${yearRange.endYear})`}
        columns={tableColumns}
        data={tableData}
