...
import useGeothermalAnalytics from './adminWindHook';
import { getTableColumns, formatDataForChart, getChartConfig, generateSampleData, validateInputs, recoverData } from './adminWindUtil';
...
const GeothermalAdmin = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const payload = {
        Year: selectedYear,
        'Wind (GWh)': parseFloat(generationValue),
