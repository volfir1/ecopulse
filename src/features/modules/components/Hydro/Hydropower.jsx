...
const SkeletonDroplet = () => (
  <div className="relative w-6 h-6 rounded-full overflow-hidden">
    <SkeletonPulse className="absolute inset-0" />
    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-200 to-cyan-100 opacity-30 animate-pulse"></div>
  </div>
);
...
const HydroPower = () => {
  ...
  const flowConfig = !isLoading ? getFlowConfig(generationData, startYear, endYear) : {};
      ...
      >
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height={400}>
            ...
            >
              <defs>
                <linearGradient id="hydropowerGradient" x1="0" y1="0" x2="0" y2="1">
