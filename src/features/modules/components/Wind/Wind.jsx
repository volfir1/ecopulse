    ...
    <div className="p-6" style={{ backgroundColor: bg.subtle }}>
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        <Card.Base className="p-4" style={{ backgroundColor: bg.paper }}>
          ...
          <p className="text-2xl font-bold" style={{ color: elements.wind }}>
        ...
        <Card.Base className="p-4" style={{ backgroundColor: bg.paper }}>
          ...
          <p className="text-2xl font-bold" style={{ color: s.main }}>
            {currentStats.windSpeed} m/s
          </p>
          <p className="text-sm mt-1" style={{ color: t.hint }}>
            Variation: {growthPercentages.windSpeed}%
          </p>
        </Card.Base>
        ...
        <Card.Base className="p-4" style={{ backgroundColor: bg.paper }}>
          ...
          <p className="text-2xl font-bold" style={{ color: s.dark }}>
      ...
      <Card.Base className="p-6 mb-6" style={{ backgroundColor: bg.paper }}>
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <CartesianGrid strokeDasharray="3 3" vertical={false} stroke={t.disabled} />
              <XAxis {...windSpeedConfig.xAxis} stroke={t.secondary} />
              <YAxis {...windSpeedConfig.yAxis} stroke={t.secondary} />
              <Tooltip 
                contentStyle={{ 
                  backgroundColor: bg.paper,
                  borderRadius: '6px',
